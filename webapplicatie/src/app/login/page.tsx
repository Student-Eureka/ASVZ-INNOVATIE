    ...
    <main className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md bg-white/95 rounded-3xl shadow-2xl border border-slate-200 overflow-hidden">
        <div className="flex items-center gap-4 px-6 py-5 bg-white">
          <img src="/logo.svg" alt="ASVZ logo" className="w-16 h-16 object-contain" />
          <div>
        ...
        <div className="px-6 py-6">
          ...
          <p className="text-xs text-slate-500 mb-5">Gebruik uw ASVZ-account om verder te gaan.</p>

          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1.5">Gebruikersnaam</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1.5">Wachtwoord</label>
              <input
                type="password"
                className="w-full bg-slate-50 border border-slate-300 rounded-lg px-3 py-2 text-sm text-slate-900 outline-none focus:border-[#E5007D] focus:ring-1 focus:ring-[#E5007D]"
